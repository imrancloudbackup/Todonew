...
if ( $("#roomKey").val().indexOf(" ") != -1 || $("#roomKey").val().indexOf("@") != -1) {
    ...
    /*vidyoConnector.Connect({
        host: "prod.vidyo.io",
        displayName: "Sachin",
        token: $("#token").val(); // OR "cHJvdmlzaW9uAGp0dXNlckA3OTFmOTYudmlkeW8uaW8ANjM4MjIwMzE3MjkAADVmZjQzODMwZmY0MmU0ZjczZmFkMjQ1ZWUxMTU1ODFiODNiNDJiMDJiMGU2MmZlMzk2YzMzOThmZTc3MGE3NmM0YWI2MDNkZmQ0MWQ2NTc5NzllYWE3MmQ2N2E3ZGI0Mg==",
        resourceId: "SalesMeeting",
    ...
    vidyoConnector.ConnectToRoomAsGuest({
        ...
        host: "instapract.platform.vidyo.io",
